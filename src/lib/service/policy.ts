/**
 * Service: AccessPolicy. Day 4 expands share + revoke; this Day 2 file
 * provides the read-side `getPolicy` so the memories/artifacts paths can
 * already enforce read/write flags.
 */
...
/** Day 2 stub for share — returns AccessPolicy. Day 4 wires Sui + cache. */
